###
### Replace XXX here with name of system, e.g. ligand used and mutations
### applied/measured. 
###

###
### Processing power requested from Bristols' HPC BluePebble4 cluster. 
###
...
### to the specified tryptophan residues for each repeat. 
### One seperate distance command per binding site. 
###


BASE_DIR="/path/to/directory/"
OUTPUT_DIR1="${BASE_DIR}/tryptophan_distances/1"
OUTPUT_DIR2="${BASE_DIR}/tryptophan_distances/2"
OUTPUT_DIR3="${BASE_DIR}/tryptophan_distances/3"
...
do
    ...
    gmx_mpi distance -f ${BASE_DIR}/${rep}/traj_pbc_corrected.xtc \
                     -oall ${OUTPUT_DIR1}/xvg/${rep}_XXX_Lig.xvg \
                     -oh ${OUTPUT_DIR1}/xvg/hist_${rep}_XXX_Lig.xvg \
                     -s ${BASE_DIR}/${rep}/md_10ns.tpr \
                     -n ${BASE_DIR}/index.ndx \
                     -select 'group "positiveN_Lig1" plus com of group "W152_sidechain"' \
                     -len 1.0 \
                     -binw 0.01
    ...
    gmx_mpi distance -f ${BASE_DIR}/${rep}/traj_pbc_corrected.xtc \
                    ...
                    -s ${BASE_DIR}/${rep}/md_10ns.tpr \
                    -n ${BASE_DIR}/index.ndx \
                    -select 'group "positiveN_Lig2" plus com of group "W364_sidechain"' \
                    -len 1.0 \
                    -binw 0.01
    ...
    gmx_mpi distance -f ${BASE_DIR}/${rep}/traj_pbc_corrected.xtc \
                     ...
                     -s ${BASE_DIR}/${rep}/md_10ns.tpr \
                     -n ${BASE_DIR}/index.ndx \
                     -select 'group "positiveN_Lig3" plus com of group "W783_sidechain"' \
                     -len 1.0 \
                     -binw 0.01
